...
public class WorldRenderer {
	...
	public WorldRenderer(WorldController worldController) {
		...
		mapBounds = worldController.getBounds();
	}
	...
	public void render(SpriteBatch spriteBatch) {
		...
		// Calculate Scissors
		ScissorStack.calculateScissors(worldController.getWorldCamera(), spriteBatch.getTransformMatrix(), worldController.getBounds(), scissor);
	...
	private void drawMapOutline() {
		...
		shapeRenderer.begin(ShapeType.Line);
		{
			...
			shapeRenderer.rect(mapBounds.getX(), mapBounds.getY(), mapBounds.getWidth(), mapBounds.getHeight());
		}
		shapeRenderer.end();
	}
