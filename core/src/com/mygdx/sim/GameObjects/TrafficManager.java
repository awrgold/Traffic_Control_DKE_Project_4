	...
	public void simulate(int finalTimeStep) {
		...
		while (lastComputedTimestep < finalTimeStep) {
			...
			for (Vehicle vehicle : vehicles) {
				...
				// Use the driver model the vehicle uses to determine the
				// vehicle's new speed
			...
			for (Vehicle vehicle : vehicles) {
				...
				System.out.println(vehicle.getLocationCoordinates(lastComputedTimestep).getX() + " Time X: " + lastComputedTimestep);
				System.out.println(vehicle.getLocationCoordinates(lastComputedTimestep).getY() + " Time Y: " + lastComputedTimestep);
			}
